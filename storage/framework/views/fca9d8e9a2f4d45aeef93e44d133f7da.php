                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" novalidate action="/loginprocess"
                                        method="POST">
                                        <?php echo csrf_field(); ?>
                                        <div class="col-12">
...
<?php /**PATH D:\ProjectKevin\Digital_Perpustakaan\resources\views/pages/auth/login.blade.php ENDPATH**/ ?>