        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Isi Form Dibawah Untuk Menambah Buku</h5>
                            <!-- Horizontal Form -->
                            <form action="/postbuku" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="row mb-3">
...
<?php /**PATH D:\ProjectKevin\Digital_Perpustakaan\resources\views/pages/dashboard/tambahbuku.blade.php ENDPATH**/ ?>