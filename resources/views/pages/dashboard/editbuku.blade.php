                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="inputText" name="judul_buku"
                                            placeholder="Masukkan Judul Buku" value="{{ $buku->judul_buku }}"
                                            required>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-select" aria-label="Default select example" required
                                            name="kategori_buku">
                                            <option selected>{{ $buku->kategori_buku }}</option>
                                            @foreach ($kategori as $item)
                                                <option value="{{ $item->kategori_buku }}">{{ $item->kategori_buku }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" id="inputEmail" name="jumlah"
                                            placeholder="Masukkan Jumlah Buku" value="{{ $buku->jumlah }}" required>
                                    </div>
                                </div>
                                <div class="row mb-3">
